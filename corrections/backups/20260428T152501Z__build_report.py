...
LANG = {
    ...
    'Singapour[Groupement]':'en','Taïwan':'zh-TW','Hong-Kong':'zh-HK',
...
single_section('Hong-Kong',
    ...
    [
        ...
        {"category":"Tone","issue":"Title uses formal `您` (`給您留言了`) but body uses informal `你` (`你好`, `給你的`, `你的意見`). zh-HK is in `formal_vous_languages` — the register must be formal end-to-end.",
