...
- [ ] **RPT-01**: Report output format is configurable — the user can choose `.md`, HTML, or PDF without editing source code
- [ ] **RPT-02**: Report structure is consistent across runs — same sections in the same order regardless of which markets are flagged
- [ ] **RPT-03**: HTML output is generated by default (human-readable in any browser, no special software, no markdown knowledge required)
